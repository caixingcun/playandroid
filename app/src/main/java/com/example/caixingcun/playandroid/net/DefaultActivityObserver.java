...
public abstract class DefaultActivityObserver<T extends ErrorBean> implements Observer<T> {
    private BaseActivity activity;
    //  Activity 是否在执行onStop()时取消订阅
    private boolean isAddInStop = false;
//    private CommonDialogUtils dialogUtils;
    public DefaultActivityObserver(BaseActivity activity) {
        this.activity = activity;
//        dialogUtils=new CommonDialogUtils();
//        dialogUtils.showProgress(activity);
    }

    public DefaultActivityObserver(BaseActivity activity, boolean isShowLoading) {
        this.activity = activity;
//        dialogUtils=new CommonDialogUtils();
//        if (isShowLoading) {
